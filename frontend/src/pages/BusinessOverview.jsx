  ...
  return (
    <main className="business-overview-main">
      ...
      <section className="overview-header">
        ...
        <p className="overview-subtitle">Aquí tienes un resumen del impacto de tus planes familiares.</p>
      </section>

      {/* Quick Actions (Bento Box style) */}
      <section className="quick-actions-grid">
        {/* Action 1: Primary Prominent */}
        <button className="action-card primary col-span-2 md:col-span-1">
          <div className="action-icon">
            <span className="material-symbols-outlined fill">add_circle</span>
          </div>
          <h3 className="action-title">Crear<br />actividad</h3>
        </button>
        ...
        <button className="action-card secondary">
          ...
          <h3 className="action-title">Crear<br />oferta</h3>
        </button>

        {/* Action 3: Utility */}
        <button className="action-card utility">
          <div className="action-icon-utility text-primary">
            <span className="material-symbols-outlined">edit_square</span>
          </div>
          <h3 className="action-title-utility">Editar<br />perfil</h3>
        </button>
        ...
        <button className="action-card utility">
          ...
          <h3 className="action-title-utility">Ver<br />reseñas</h3>
        </button>
      </section>
          ...
          <div className="kpi-card">
            ...
            <div className="kpi-header z-10">
              <div className="kpi-icon bg-secondary-light text-on-secondary-container">
                <span className="material-symbols-outlined fill">local_offer</span>
              </div>
              <span className="kpi-label">Activas</span>
            </div>
            <div className="kpi-value-row z-10">
          ...
          <div className="kpi-card">
            <div className="kpi-header z-10">
              <div className="kpi-icon bg-yellow-light text-tertiary-container">
                <span className="material-symbols-outlined fill">star_rate</span>
              </div>
              <span className="kpi-label">Reseñas</span>
            </div>
            <div className="kpi-value-row z-10">
              <span className="kpi-value">12</span>
              <span className="kpi-subtext text-primary flex items-center">+2 esta semana</span>
            </div>
          </div>
